...
- [Quickstart](../QUICKSTART.md) — the first working loop.
...
- [Generated Engram Index](../Engram/INDEX.md) — find content; generated by CLI, not edited manually.
- [Brain Log](../Engram/LOG.md) — search the append-only operation timeline.
- [Brain Context](../Engram/CONTEXT.md) — current approved personal state and priorities.
- [Maintainer Guide](../docs/MAINTAINING.md) — how to propagate core changes between repos.
