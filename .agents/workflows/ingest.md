...
4. Preserve an immutable locator manifest and available artifact under `Brain/Sources/Raw/<domain>/`.
5. Prepare the derived-record proposal under `Brain/Sources/Records/<domain>/`; every derived claim requires approval before writing.
...
10. Maintain the complete corpus `Brain/INDEX.md`, append a policy-conforming `Brain/LOG.md` entry, and record contradictions and open questions.
