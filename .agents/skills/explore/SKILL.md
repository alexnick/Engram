---
name: explore
description: Use to develop or stress-test an unclear idea through focused, one-at-a-time questions.
---
...
Do not write derived Knowledge, Decisions, project context, health interpretation, or other semantic state without Sync approval. Do not code unless the user explicitly ends Explore and requests implementation.
